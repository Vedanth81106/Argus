    ...
    return (
        <div className="relative min-h-screen overflow-hidden flex items-center justify-center">
            ...
            <div className="text-center space-y-5 max-w-2xl z-10 relative text-foreground">
                ...
                <p className="text-lg text-pretty pb-10">
                    Automated code reviews and{" "}
                    <span className="bg-clip-text text-transparent bg-linear-to-r from-primary to-ternary">
                        security-monitoring
                    </span>{" "}
                    powered by AI. Get instant feedback on every commit and keep your{" "}
                    <span className="bg-clip-text text-transparent bg-linear-to-r from-ternary to-primary">
                        repositories
                    </span>{" "}
                    clean, secure, and optimized.
                </p>
